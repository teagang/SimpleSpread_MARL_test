...
def plot_learning_curves(file_path, y_min=None, y_max=None):
    ...
    containing folder of the progress.csv file.
    ...
    plot_filename = f"{plot_base_name}_learning_curve.png"
    ...
    for col in reward_columns:
        ...
        if match:
            ...
            plt.plot(df['training_iteration'], df[col], label=agent_name, alpha=1.0)    
...
if __name__ == '__main__':
    ...
    print("Calculating global min and max reward across all files...")
    ...
    print("\nGenerating plots with consistent y-axis...")
    for file_path in all_progress_files:
