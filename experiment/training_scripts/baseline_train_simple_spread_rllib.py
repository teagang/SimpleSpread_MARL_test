...
EXPERIMENT_NAME = "simple_spread_baseline_standard_reward"
...
# RLlib new API stack expects (agent_id, episode, **kwargs)
...
config = (
    ...
    .environment(env="simple_spread_pz", clip_actions=False)
